                ...
                <form class="form-horizontal" action="{{ route('change_password') }}" method="post">
                    ...
                    <div class="box-body box-change-password">
                        <div class="form-group current-password @if ($errors->has('current_password')) has-error @endif">
                            <label for="exampleInputEmail1" class="col-sm-3 control-label">{{ __('change_password.current_password') }} <span class="required">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group new-password @if ($errors->has('new_password')) has-error @endif">
                            <label for="exampleInputPassword1" class="col-sm-3 control-label">{{ __('change_password.new_password') }} <span class="required">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group confirm-new-password @if ($errors->has('confirm_new_password')) has-error @endif" >
                            <label for="exampleInputPassword1" class="col-sm-3 control-label">{{ __('change_password.confirm_new_password') }} <span class="required">*</span></label>
                            <div class="col-sm-9">
